...
class ResponseMixin:
    ...
    def paginated_response(self, results, page, page_size, total_records, message="Success.", status_code=status.HTTP_200_OK):
        ...
        return self.success_response(data=payload, message=message, status_code=status_code)
